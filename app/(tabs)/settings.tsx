...
const styles = StyleSheet.create({
  ...
  accountMask: { fontSize: 12, color: "#6B7280", marginTop: 2 },
  link: { fontSize: 14, color: "#3D8E62", fontWeight: "500" },
  ...
  muted: { fontSize: 13, color: "#9CA3AF", marginBottom: 12 },
  infoBox: {
    flexDirection: "row",
  ...
  infoText: { fontSize: 13, color: "#2D5A44", flex: 1, lineHeight: 20 },
  browserLink: {
    flexDirection: "row",
    alignItems: "center",
    gap: 8,
  ...
  browserLinkText: { fontSize: 14, color: "#3D8E62", fontWeight: "500" },
